...
interface PopupCadastroPacienteSucessoProps {
  isOpen: boolean;
  onClose: () => void;
  dados: {
    nome: string;
...
export default function PopupCadastroPacienteSucesso({
  isOpen,
  onClose,
  dados,
}: PopupCadastroPacienteSucessoProps) {
